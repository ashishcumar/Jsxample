...
export const Landing = () => {
  ...
  return (
    ...
    >
      ...
      >
        <HStack spacing={3}>
          <Heading size="xl" fontWeight="semibold" color="accent">
            JSXample
          </Heading>
          <Badge 
            colorScheme="purple" 
            variant="subtle" 
            fontSize="sm"
            bg={{ light: "purple.100", dark: "purple.900" }}
          >
            BETA
          </Badge>
        </HStack>
      ...
      {/* Main Content */}
      <Box textAlign="center">
        <Heading as="h1" size="2xl" mb={5} lineHeight="1.2" fontWeight="700" color="text">
          Frontend Interview Practice
          <Text as="span" color="accent" display="block">
            Machine Coding & JS Solutions
          </Text>
        </Heading>
        ...
        >
          {categories.map((category) => (
            <Box
              ...
              borderColor={{ light: "border.light", dark: "border.dark" }}
            >
              <Tag
                colorScheme={category.color}
                size="lg"
