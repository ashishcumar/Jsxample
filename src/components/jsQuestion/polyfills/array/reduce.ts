const reduce = {
  ...
  description:
    "Implement a polyfill for the Array.prototype.reduce() method which executes a reducer function on each element of the array, resulting in a single output value.",
